...
router.post("/sign-up", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingUser = yield database_1.default.query("SELECT * FROM marketplace_app.users_info WHERE email = ?", [email]);
    const existingSitter = yield database_1.default.query("SELECT * FROM marketplace_app.sitters_info WHERE email = ?", [email]);
    ...
    if (req.body.type === "customer") {
        ...
        yield database_1.default.query("INSERT INTO marketplace_app.users_info (first_name, last_name, email, password, type) VALUES (?)", [userData]);
    }
        ...
        yield database_1.default.query("INSERT INTO marketplace_app.sitters_info (first_name, last_name, email, password, type, summary, hour_rate, day_rate) VALUES (?)", [sitterData]);
    }
    res.send("added");
}));
//////////////////////////////////////////////////////
...
router.post("/log-in", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const registeredUser = (yield database_1.default.query("SELECT * FROM marketplace_app.users_info WHERE email = ?", [req.body.email]));
    const registeredSitter = (yield database_1.default.query("SELECT * FROM marketplace_app.sitters_info WHERE email = ?", [req.body.email]));
